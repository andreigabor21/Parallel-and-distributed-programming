package main.java.ro.ubb;

import main.java.ro.ubb.domain.Polynomial;
import main.java.ro.ubb.domain.Product;
import mpi.MPI;
...
public class Main {
    private static final String APPROACH1 = "Simple";
    private static final String APPROACH2 = "Karatsuba";
    private static final int ORDER = 10;

    public static void main(String[] args) {
        String approachType = APPROACH2;
        ...
        if (me == 0) {
            ...
            if (approachType.equals(APPROACH1)){
