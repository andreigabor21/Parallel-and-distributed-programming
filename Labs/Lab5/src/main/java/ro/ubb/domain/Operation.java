...
import static ro.ubb.domain.Utils.MAX_DEPTH;
import static ro.ubb.domain.Utils.THREAD_COUNT;
...
public class Operation {
    ...
    public static Polynomial simpleThreaded(Polynomial p1, Polynomial p2)
        ...
        int step = result.getLength() / THREAD_COUNT;
        if (step == 0) {
            step = 1;
        }
